package app.com.example.android.sunshine.widget;
...
public class TodayWidgetIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            //views.setImageViewResource(R.id.widget_icon, R.drawable.art_clear);
            ...
            /*views.setTextViewText(R.id.widget_high_temperature, "24");
            views.setTextViewText(R.id.widget_description, "clear");
            views.setTextViewText(R.id.widget_low_temperature, "10");
*/
